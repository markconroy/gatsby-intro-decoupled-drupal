...
const LayoutPage = () => (
  <Layout>
    ...
    <p>It uses a GraphQL StaticQuery to query the <strong>gatsby-config.js file</strong> to grab the site title as a prop. It then renders the {`<Header>`} component and injects the site title as the siteTitle <strong>prop</strong>. Did you notice we changed it to "GatsbyJS Intro"</p>
